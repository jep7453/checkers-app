...
| ---------- | -------------------- | -------- | --------------------------------------------------------- | -------- | --------------------------------------------------------- | -------- | --------------------------------------------------------- |
| As a Player I want to sign-in so that I can play a game of checkers. | Given that I have not yet signed in when I see the Home page then I must see a means to sign-in. (such as a link or button) | PASS | CT 2-28-2020; I saw a means to sign in
